...
class EditProfile3PresenterImpl(private val networkService: NetworkService) :EditProfile3Presenter{


    lateinit var v:EditProfile3MvpView

    //    var searchView: SearchView? = null            //init views here
    private val compositeDisposable = CompositeDisposable()

    override fun attach(view: MvpView) {
        v=view as EditProfile3MvpView
