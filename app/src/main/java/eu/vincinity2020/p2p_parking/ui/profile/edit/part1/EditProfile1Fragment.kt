...
class EditProfile1Fragment : BaseFragment(), EditProfile1MvpView{
...
////        tvCountry.setText( user.country.country)
    ...
    @Inject
    lateinit var presenter: EditProfile1Presenter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        (activity?.application as App)
                .appComponent()
                .editProfile1ComponentBuilder()
                .viewProfileModule(EditProfile1Module())
                .build()
                .inject(this)
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.fragment_edit_profile_1, container, false)
    }
...
//        (activity as NavigationActivity ).selectedFragmentTag = EditProfileActivity.EDIT_PROFILE_1
