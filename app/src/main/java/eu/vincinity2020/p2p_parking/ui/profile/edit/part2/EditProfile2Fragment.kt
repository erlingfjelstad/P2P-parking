...
import eu.vincinity2020.p2p_parking.ui.navigation.NavigationActivity.Companion.EDIT_PROFILE_3
...
class EditProfile2Fragment : BaseFragment(), EditProfile2MvpView{
...
////        tvCountry.setText( user.country.country)
    ...
    @Inject
    lateinit var presenter: EditProfile2Presenter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        (activity?.application as App)
                .appComponent()
                .editProfile2ComponentBuilder()
                .viewProfileModule(EditProfile2Module())
                .build()
                .inject(this)
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.fragment_edit_profile_2, container, false)
    }
...
//        (activity as NavigationActivity).selectedFragmentTag = EditProfileActivity.EDIT_PROFILE_2
...
//    }
    ...
    fun onProfile3Clicked() {
        ...
        (activity as NavigationActivity).selectedFragmentTag = EDIT_PROFILE_3
