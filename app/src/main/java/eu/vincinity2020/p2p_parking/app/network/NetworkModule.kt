...
class NetworkModule {
    ...
    fun providesRetrofit(okHttpClient: OkHttpClient,
        ...
        return Retrofit.Builder()
                ...
                .baseUrl("http://52.215.239.213:8100")
                .client(okHttpClient)
                .build()
    }
    ...
    @ApplicationScope
    @Provides
    fun providesOkhttp(context: Context, cache: Cache, httpLoggingInterceptor: HttpLoggingInterceptor): OkHttpClient {
        val builder = OkHttpClient.Builder()
        builder.cache(cache)
        builder.setCookieStore(context)
