package eu.vincinity2020.p2p_parking.choose
...
import eu.vincinity2020.p2p_parking.map.ParkingSpotAdapter
        ...
        recyclerview_promoted_spots.addOnScrollListener(object : RecyclerView.OnScrollListener() {
            override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
                ...
                if (position >= 0 && dx != 0) {
                    ...
                    val geoPoint = GeoPoint(itemAtPosition.latitude, itemAtPosition.longitude)
